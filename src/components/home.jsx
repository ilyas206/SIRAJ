...
export default function Home(){
    ...
    return(
        <div dir={language === 'ar' ? 'rtl' : 'ltr'} className="home overflow-hidden relative w-full min-h-[calc(100vh-90px)] flex flex-col items-center justify-center text-slate-200 p-4">
            ...
            <p className="heroText z-20">{handleTranslation('Built for the Ummah as a free guide everyday')}.</p>
            <img src="assets/images/moon.png" ref={moon} alt="Hilal" className="absolute opacity-70 left-4 bottom-7 md:bottom-1 md:w-56 w-36 h-36 md:h-56 lg:w-66 lg:h-66 " />
